...
import { ReferralRewardForm } from "./reward-form";
  ...
  return (
    <div>
      ...
      <p className="mt-1 text-sm text-muted">
        Ajuste a premiação aqui. Crédito só após o primeiro pagamento.
      </p>

      <ReferralRewardForm initial={rewards} />

      <h2 className="mt-10 text-lg font-semibold text-ink">Histórico</h2>
      {rows.length === 0 ? (
        <p className="mt-3 text-sm text-muted">Nenhuma indicação ainda.</p>
      ) : (
